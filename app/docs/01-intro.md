...
**Место для скриншота 1:** общая схема проекта. Схему можно нарисовать
в draw.io или Excalidraw: три блока (infra, k8s, app), соединяющие
их GitHub Actions, и снизу — Yandex Cloud.
...
**Место для скриншота 2:** три открытых репозитория на GitHub с README.